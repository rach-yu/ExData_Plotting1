##This script contains R code for Plot4. 
...
##topleft
with(hpc,plot(Weekdays, Global_active_power, type = "l", main = "", xlab = "", ylab = "Global ActivePower"))

##topright
with(hpc,plot(Weekdays, Voltage, type = "l", main = "", xlab = "datetime", ylab = "Voltage"))
...
legend("topright", bty = "n", lty = 1, col = c("black","red","blue"), cex = 0.8, legend = leg.txt)

##bottomright
with(hpc,plot(Weekdays, Global_reactive_power, type = "l", main = "", xlab = "datetime"))
